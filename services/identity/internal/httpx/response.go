// Package httpx — uniform JSON response/error envelopes.
//
// Success: {"data": ...}
...
// WriteErr writes any error. Recognized *APIError values produce their
// declared status; everything else becomes a 500 with the error logged.
...
// DecodeJSON reads and validates a JSON request body. Body is required
// to be non-empty and well-formed; max 1 MiB by default.
