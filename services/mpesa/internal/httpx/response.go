// Uniform JSON response/error envelopes — same shape as identity /
// notification / member. Lifted verbatim and re-homed to the mpesa
// module so this service can stand alone.
//   Success: {"data": ...}
